...
* `WIDE_CHARACTER` 仅在内存中使用。**<font color="red">注意：这个格式vc/c++中直接使用的格式不同</font>**<br>
	* VC/C++ wchar_t实现方式<br>
	...
	wchar_t str = "中国abc";
	```
	![wchar_t 空间分配规则][https://github.com/WangSiCong1988/Libs_WinString/tree/dev/img/wchar_t空间分配规则.bmp]<br>
...
* `ISO_8859_1`
* `GB18030`<br>
![GB18030字符集编码规则][https://github.com/WangSiCong1988/Libs_WinString/tree/dev/img/GB18030字符集编码规则.webp]<br>
* `GB2312`
